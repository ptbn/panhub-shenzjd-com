...
- `config/`: runtime configuration (defaults for concurrency, timeouts, cache TTL).
...
- This project runs without a database: keep state in memory; do not introduce persistent storage dependencies.
